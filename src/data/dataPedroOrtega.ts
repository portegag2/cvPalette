...
export const pedroData = {
  ...
  "experiencia_laboral": [
    ...
    },
    {
      ...
      "entidad": "Estudio Arquitectura San Andrés",
      "fecha": "10/2001 – 11/2003",
      "descripcion": "Aprovisionamiento, instalación y mantenimiento de material informático y telefonía. Desarrollo de BD para la gestión de horas (Access)."
    },
    {
      "titulo": "Programador Senior – NATStar, SQL Windows",
      "entidad": "Ceinsa, Ibermática, Bilbomática",
      "fecha": "06/1997 – 06/2000",
      "descripcion": "Programador Senior cedido en los clientes Banesto (NATStar), Iberdrola (NATStar) y Gobierno Vasco (SQLWindows)."
    }
  ],
  "formacion": [
    {
      "titulo": "Ingeniero en Informática",
      "entidad": "Universidad de Deusto",
